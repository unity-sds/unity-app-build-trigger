...
build-app-gen:
  ...
  script:
    ...
    - python3 /home/gitlab-runner/unity-app-generator/build_ogc_app.py init $CI_PROJECT_DIR
    - python3 /home/gitlab-runner/unity-app-generator/build_ogc_app.py build_docker
